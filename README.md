...
## Information
- Recreation of Apple's Settings app for tvOS 26.1 (23J582).
- Based off of the layout matching Simulator and not a physical Apple TV for now.
- All features within the app are only simulations and have no effect on the device outside of the app.
- Previous versions are available as their own branches, going as far back as 18.5. Less features are available in earlier versions.
...
## Usage
Open in Xcode and run with either Simulator or a paired physical device running tvOS as a destination.
